...
const ru: Dictionary = {
  ...
  "meta": {
    "title": "Ная ОС",
    "description": "Naia OS — ваш личный ИИ стал проще. Общайтесь, разговаривайте и работайте с 3D ИИ-аватаром."
  },
  "common": {
    "loading": "Загрузка...",
  ...
  "home": {
    "hero": {
      ...
      "subtitle": "От 7 поставщиков ИИ до управления терминалом и аватара VRM, выражающего эмоции. Полная экосистема искусственного интеллекта, с которой вы можете ознакомиться, не будучи разработчиком, Naia OS.",
      "cta": "Начни бесплатно",
